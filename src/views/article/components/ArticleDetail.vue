              ...
              <el-row>
                <el-col :span="8">
                  <el-form-item label-width="60px" label="作者:" class="postInfo-container-item">
                    <el-select v-model="postForm.author" :remote-method="getRemoteUserList" filterable default-first-option remote placeholder="查询用户">
                ...
                <el-col :span="6">
                  <el-form-item label-width="90px" label="重要级:" class="postInfo-container-item">
                    <el-rate
