<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-select v-model="listQuery.type" placeholder="国籍" clearable class="filter-item" style="width: 130px">
    ...
    <el-dialog :visible.sync="dialogPvVisible" title="在线阅读统计系统">
...
const calendarTypeOptions = [
  ...
  { key: 'US', display_name: '美国（US）' },
  { key: 'JP', display_name: '日本（JP）' },
  { key: 'EU', display_name: '欧盟（EU）' }
];
